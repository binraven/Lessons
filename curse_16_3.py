...
async def update_user(username: str = Path(min_length=5, max_length=20, description="Enter username", example="UrbanUser")
                         , age: int = Path(ge=18, le=120, description="Enter age'", example="24"),
                      user_id: int = Path(ge=1, le=100, description="Enter User ID", example="123")) -> str:
